...
public class TestShiroAuthentication {
    ...
    public void testSecurityManager() {
        ...
        IniSecurityManagerFactory iniSecurityManagerFactory = new IniSecurityManagerFactory("classpath:shiroATMD5/shiroAT.ini");
        ...
        //用户令牌(前台传来的表单信息)  密码会经过自定义的hash凭证匹配器加密后和数据库中的密文再比对
